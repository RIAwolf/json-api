...
class JSON_API_vvkd_depths_Controller
{
    ...
    public function get_values()
    {
        global $wpdb;
        global $json_api;
        $table_name = $wpdb->prefix . JSON_API_Depths::TABLE_NAME;
    ...
    public function put_value()
    {
        ...
        global $json_api;
        $newSegment = new JSON_API_Depths($json_api->query);
        $newSegment->save();
        return "done";
    }
